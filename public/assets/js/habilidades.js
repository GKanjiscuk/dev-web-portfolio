...
const sobreSkill = [
                    ...
                    '<p>Github</p> <br> <p>É uma plataforma de hospedagem de código-fonte e arquivos com controle de versão usando o Git. </p> <br>','<p>Bootstrap</p> <br> <p>É um framework front-end que fornece estruturas de CSS para a criação de sites e aplicações responsivas de forma rápida e simples</p> <br>', '<p>TypeScript</p> <br> <p>Uma linguagem de programação, superset do JavaScript, que adiciona tipagem estática opcional à linguagem, permitindo um desenvolvimento mais seguro, compreensível e com melhores ferramentas de auxílio em projetos web e Node.js de qualquer escala.</p> <br></br>', '<p>React</p> <br> <p>Uma biblioteca JavaScript para a construção de interfaces de usuário (UIs) interativas e dinâmicas, focada em componentes reutilizáveis e uma abordagem declarativa para simplificar o desenvolvimento de aplicações web de página única (SPAs) e interfaces complexas.</p>', '<p>Tailwind</p> <br> <p>Um framework CSS utilitário de baixo nível que permite estilizar elementos HTML diretamente no seu markup através de classes predefinidas, oferecendo flexibilidade e rapidez no desenvolvimento de interfaces personalizadas sem a necessidade de escrever CSS tradicional extenso</p>', '<p>Nodejs</p> <br> <p>Um ambiente de tempo de execução JavaScript construído sobre o motor V8 do Chrome, que permite executar código JavaScript fora do navegador, sendo amplamente utilizado para construir aplicações de servidor escaláveis, APIs e ferramentas de linha de comando, aproveitando a familiaridade e o ecossistema vasto do JavaScript.</p>'
]
